...
public class CloneFileInfoTypeInfo extends TypeInformation<CloneFileInfo> {
    ...
    @Override
    public TypeSerializer<CloneFileInfo> createSerializer(ExecutionConfig config) {
        return new KryoSerializer<>(CloneFileInfo.class, config);
    }
